...
public class Main {
    ...
    private static void virhetilanteita() {
        ...
        System.out.println("new Varasto(-10.0, 10.0)");
        huono = new Varasto(-10.0,10.0);
        System.out.println(huono);
    }
    
    private static void lisaaVarastoon(Varasto mehua, Varasto olutta) {
        System.out.println("Olutvarasto: " + olutta);
    ...
    private static void otaVarastosta(Varasto mehua, Varasto olutta) {
        System.out.println("Olutvarasto: " + olutta);
